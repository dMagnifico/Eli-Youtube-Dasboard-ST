# -*- coding: utf-8 -*-
"""
Created on Tuesday September 12 21:35 2023
...
#Engineering data to compare video against median for last 12 months
...
if add_sidebar == 'Aggregate Metrics':
    ...
    #trim to relevant data alongside date info
...
#define a figure//chart
    ...
    fig2.add_trace(go.Scatter(x=first_30['days_published'], y=first_30['Views'].cumsum(),
                        mode='lines', 
                        name='Current Video' ,line=dict(color='firebrick',width=5)))
